...
一覧の掲載日を開催日として使うことはありません。掲載年は本文に年のない日付の年を補うために使用し、11〜12月公開の記事の1〜2月予定は翌年扱いにします。曜日との矛盾は要確認にします。2026年度（2026年4月1日〜2027年3月31日）を対象とし、終了済みの開催日・締切も残します。複数日企画は各日に表示し、月選択で過去月にも移動できます。年度は自動で切り替えません。
...
PDFや画像だけに日程がある記事、複数企画の区別が不明な記事、本文構造が変わった記事は、日付を推測せず「日付確認要」に表示します。日付なしの案内は2026年3月以降の年度関連情報を対象にします。「ふくしま」ツアーの3行程と、開催要項で置き換えられたSPK・秋の共済セミナーの合同案内は個別に対応しています。

6カテゴリのページ送りを最後まで取得し、過去の案内と開催報告も確認します。報告にある次回のむさっしーず・相談会も取り込みます。名称変更が確認できた重複記事は統合し、詳細案内を開催報告より優先します。

2026年度年間予定表とPeace Now!申込案内PDFは、確認済みの情報を `scripts/annual_schedule.json` に保持しています。毎週PDFの内容一致も確認し、差し替えられていた場合は確認済み日付の適用を止めて「日付確認要」に表示します。新しいPDFの内容を自動解釈するものではありません。年間予定だけのイベントには「詳細未発表」を表示し、月しか判明していない予定は日にちを推測しません。
